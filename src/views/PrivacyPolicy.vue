<template>
	<article class="privacy_policy">
		...
		<p class="ls2 lh6 bs5 ts4">
			<em class="emphasis">
				<SunrinPay
					>('https://sunrinpay.com' 이하 'SunrinPay')</SunrinPay
				> </em
		...
		<p class="ls2 lh6 bs5 ts4">
			<em class="emphasis">
				<SunrinPay>('SunrinPay')</SunrinPay> </em
			...
			<strong>
				...
				<em class="emphasis">
					<SunrinPay
						>('https://sunrinpay.com'이하 'SunrinPay')</SunrinPay
					> </em
				>은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한
		...
		<p class="ls2">
			서비스 제공, 청구서 발송, 콘텐츠 제공 등을 목적으로 개인정보를
			처리합니다.
		</p>
		<br />
		<br />
		...
		<p class="ls2">
			1. 개인정보 파일명 : 회원 정보
			<br />
			- 개인정보 항목 : 이메일, 비밀번호, 로그인ID, 이름, 서비스 이용
			기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록 <br />
			- 수집방법 : 홈페이지 <br />
			- 보유근거 : 개인정보 제공 동의 <br />
			- 보유기간 : 준영구 <br />
			- 관련법령 :
		...
		관한 동의일로부터&lt;준영구>까지 위 이용목적을 위하여 보유.이용됩니다.
		...
		②
		<em class="emphasis">
			<SunrinPay>('https://sunrinpay.com')</SunrinPay> </em
		...
		<p class="ls2">
			<br />1.
			<Firebase
				><br />- 개인정보를 제공받는 자 : Firebase (Google)</Firebase
			>
			<br />- 제공받는 자의 개인정보 이용목적 : 로그인ID <br />- 제공받는
			자의 보유.이용기간: 준영구
		</p>
		<br />
		<br />
		...
		<p class="ls2">
			① 정보주체는 SunrinPay에 대해 언제든지 개인정보
			열람,정정,삭제,처리정지 요구 등의 권리를 행사할 수 있습니다.
			<br />② 제1항에 따른 권리 행사는SunrinPay에 대해 개인정보 보호법
			시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여
			하실 수 있으며 SunrinPay은(는) 이에 대해 지체 없이 조치하겠습니다.
			...
			<br />⑥ SunrinPay은(는) 정보주체 권리에 따른 열람의 요구,
		...
		<p class="ls2">
			...
			않습니다. <br /><br />-파기기한 <br />이용자의 개인정보는 개인정보의
		...
		<p class="ls2">
			-파기방법<br />전자적 파일 형태의 정보는 기록을 재생할 수 없는
			기술적 방법을 사용합니다.<br />종이에 출력된 개인정보는 분쇄기로
			분쇄하거나 소각을 통하여 파기합니다.
		</p>
		<br /><br />
		<p class="lh6 bs4">
			<strong
				>9. 개인정보 자동 수집 장치의 설치•운영 및 거부에 관한
				사항</strong
			>
		</p>
		<p class="ls2">
			① SunrinPay 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를
			...
			어려움이 발생할 수 있습니다.<br /><br />
		</p>

		<p class="lh6 bs4"><strong>10. 개인정보 보호책임자 작성 </strong></p>
		<br />
		① SunrinPay(‘https://sunrinpay.com’이하 ‘SunrinPay) 은(는) 개인정보
		처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의
		불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를
		지정하고 있습니다.
		<p class="ls2">
			<br />▶ 개인정보 보호책임자 <br />성명 :김현우<br />직책 :EDCAN
			5기<br />직급 :대표<br />연락처 :050700797709, admin@hyunwoo.kim,
			<br />※ 개인정보 보호 담당부서로 연결됩니다.<br />
			<br />▶ 개인정보 보호 담당부서 <br />부서명 :개인정보보호담당<br />담당자
			:김현우<br />연락처 :050700797709, admin@hyunwoo.kim, <br />②
			정보주체께서는 SunrinPay(‘https://sunrinpay.com’이하 ‘SunrinPay) 의
			서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련
			문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및
			담당부서로 문의하실 수 있습니다.
			SunrinPay(‘https://sunrinpay.com’이하 ‘SunrinPay) 은(는) 정보주체의
		...
		<p class="ls2">
			▶ 개인정보 열람청구 접수·처리 부서 <br />부서명 :
			개인정보열람청구<br />담당자 : 김현우<br />연락처 : 050700797709,
			admin@hyunwoo.kim,
		</p>
		...
		<br />
		<p class="ls2">
			▶ 행정안전부 개인정보보호 종합지원 포털 → 개인정보 민원 → 개인정보
		...
		<p>
			...
			<br />3.관리책임자, 담당부서 및 영상정보에 대한 접근권한자 : 바코드
			스캔 이후 소멸 및 삭제<br /><br />4.영상정보 촬영시간, 보관기간,
			보관장소, 처리방법 <br />
			- 촬영시간 : 1<br />
			- 보관기간 : 촬영시부터 바로 삭제<br />
			- 보관장소 및 처리방법 : 보관하지 않음<br /><br />5.영상정보 확인
			방법 및 장소 : 보관하지 않음<br />
			<br />6.정보주체의 영상정보 열람 등 요구에 대한 조치 : 보관하지
			않음<br /><br />7.영상정보 보호를 위한 기술적.관리적.물리적 조치 :
		</p>
	</article>
</template>
