  ...
  <div class="receipt">
    ...
    <div class="receipt__wrap">
      <div class="receipt__title">
        <img
          src="https://firebasestorage.googleapis.com/v0/b/sunrinpay.appspot.com/o/ReceiptLogo.svg?alt=media&token=657c8dbc-1718-484a-a374-21daa7b396ca"
          class="receipt__title__image"
        />
        <div>
          <h1>{{ setting.name }}</h1>
          <p>{{ setting.address }}</p>
      ...
      <div class="receipt__total">
        ...
        <p>
          {{
            data.type == '충전'
              ? '+' + Number(data.totalPrice).numberFormat()
              : Number(data.totalPrice).numberFormat()
          }}
        </p>
      </div>
